...
![OSI 七层模型](https://oss.javaguide.cn/github/javaguide/cs-basics/network/osi-7-model.png)OSI 七层模型
...
![osi七层模型2](https://oss.javaguide.cn/github/javaguide/osi七层模型2.png)osi七层模型2

#### [#](#tcp-ip-四层模型是什么-每一层的作用是什么) TCP/IP 四层模型是什么？每一层的作用是什么？
...
#### [#](#网络层有哪些常见的协议) 网络层有哪些常见的协议？

![网络层常见协议](E:/assets/nerwork-layer-protocol-040eb203.png)网络层常见协议
...
- [从输入 URL 到页面加载发生了什么？open in new window](https://segmentfault.com/a/1190000006879700)
...
![常见 HTTP 状态码](https://oss.javaguide.cn/github/javaguide/cs-basics/network/http-status-code.png)常见 HTTP 状态码
...
![HTTP 和 HTTPS 对比](https://oss.javaguide.cn/github/javaguide/cs-basics/network/http1.0-vs-http1.1.png)HTTP 和 HTTPS 对比
...
- **IO 多路复用（Multiplexing）**：<u>HTTP/2.0 在同一连接上可以同时传输多个请求和响应</u>（可以看作是 HTTP/1.1 中长链接的升级版本）。HTTP/1.1 则使用串行方式，每个请求和响应都需要独立的连接。这使得 HTTP/2.0 在处理多个请求时更加高效，减少了网络延迟和提高了性能。
...
### [#](#dns-解析的过程是什么样的) DNS 解析的过程是什么样的？

整个过程的步骤比较多，我单独写了一篇文章详细介绍：[DNS 域名系统详解（应用层）]() 。

------

著作权归Guide所有 原文链接：https://javaguide.cn/cs-basics/network/other-network-questions.html#dns-%E7%9A%84%E4%BD%9C%E7%94%A8%E6%98%AF%E4%BB%80%E4%B9%88