...
![关系型数据库表关系](https://oss.javaguide.cn/java-guide-blog/5e3c1a71724a38245aa43b02_99bf70d46cc247be878de9d3a88f0c44.png)关系型数据库表关系
...
日常开发中，text 类型用的很少，但偶尔会用，



类型就属于是基本不用。如果预期长度范围 varchar 就满足，就避免使用 text。
...
![img](https://oss.javaguide.cn/github/javaguide/mysql/image-20220510155143458.png)
...
![《Java 面试指北》技术面试题篇](https://oss.javaguide.cn/javamianshizhibei/technical-interview-questions.png)《Java 面试指北》技术面试题篇
...
![AID->C](https://oss.javaguide.cn/github/javaguide/mysql/AID->C.png)AID->C
...
![脏读](E:/assets/concurrency-consistency-issues-dirty-reading-ee15b0b9.png)脏读
...
![丢失修改](E:/assets/concurrency-consistency-issues-missing-modifications-5b2e2bd8.png)丢失修改
...
![不可重复读](E:/assets/concurrency-consistency-issues-unrepeatable-read-ff9186e1.png)不可重复读
...
![幻读](E:/assets/concurrency-consistency-issues-phantom-read-7cba7a85.png)幻读
...
![img](https://oss.javaguide.cn/github/javaguide/mysql/oss-search.png)
...
![常见的 SQL 优化手段](https://oss.javaguide.cn/javamianshizhibei/javamianshizhibei-sql-optimization.png)常见的 SQL 优化手段
...
著作权归Guide所有 原文链接：https://javaguide.cn/database/mysql/mysql-questions-01.html 