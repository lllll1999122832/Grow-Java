...
[Guide](https://javaguide.cn/article/)数据库MySQL约 3064 字大约 10 分钟
...
> 本文来自[木木匠open in new window](https://github.com/kinglaw1204)投稿。
...
### [#](#_1-1-mysql-基本架构概览) 1.1 MySQL 基本架构概览
...
![img](https://oss.javaguide.cn/javaguide/13526879-3037b144ed09eb88.png)4
...
### [#](#_1-2-server-层基本组件介绍) 1.2 Server 层基本组件介绍
...
#### [#](#_2-查询缓存-mysql-8-0-版本后移除) 2) 查询缓存(MySQL 8.0 版本后移除)
