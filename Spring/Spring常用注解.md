...
[Guide](https://javaguide.cn/article/)框架SpringBootSpring约 5491 字大约 18 分钟
...
### [#](#_1-springbootapplication) 1. `@SpringBootApplication`
...
### [#](#_2-spring-bean-相关) 2. Spring Bean 相关

#### [#](#_2-1-autowired) 2.1. `@Autowired`
...
#### [#](#_2-2-component-repository-service-controller) 2.2. `@Component`,`@Repository`,`@Service`, `@Controller`
...
#### [#](#_2-3-restcontroller) 2.3. `@RestController`
...
#### [#](#_2-5-configuration) 2.5. `@Configuration`
...
### [#](#_3-处理常见的-http-请求类型) 3. 处理常见的 HTTP 请求类型
...
#### [#](#_4-1-pathvariable-和-requestparam) 4.1. `@PathVariable` 和 `@RequestParam`
...
#### [#](#_4-2-requestbody) 4.2. `@RequestBody`
...
![img](E:/assets/@RequestBody-84a28a13.png)
...
#### [#](#_5-2-configurationproperties-常用) 5.2. `@ConfigurationProperties`(常用)
...
#### [#](#_5-3-propertysource-不常用) 5.3. `@PropertySource`（不常用）
...
![img](https://oss.javaguide.cn/2021/03/c7bacd12-1c1a-4e41-aaaf-4cad840fc073.png)
...
#### [#](#_6-1-一些常用的字段验证的注解) 6.1. 一些常用的字段验证的注解
...
#### [#](#_6-2-验证请求体-requestbody) 6.2. 验证请求体(RequestBody)
...
#### [#](#_6-3-验证请求参数-path-variables-和-request-parameters) 6.3. 验证请求参数(Path Variables 和 Request Parameters)
...
### [#](#_7-全局处理-controller-层异常) 7. 全局处理 Controller 层异常
...
#### [#](#_8-4-指定不持久化特定字段) 8.4. 指定不持久化特定字段
...
### [#](#_9-事务-transactional) 9. 事务 `@Transactional`
...
### [#](#_10-json-数据处理) 10. json 数据处理

#### [#](#_10-1-过滤-json-数据) 10.1. 过滤 json 数据
...
#### [#](#_10-2-格式化-json-数据) 10.2. 格式化 json 数据
...
著作权归Guide所有 原文链接：https://javaguide.cn/system-design/framework/spring/spring-common-annotations.html#_10-json-%E6%95%B0%E6%8D%AE%E5%A4%84%E7%90%86